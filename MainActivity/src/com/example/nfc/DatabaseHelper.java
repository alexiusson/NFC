...
static final String SQL_CREATE_READ_TABLE = ("CREATE TABLE "+ DB_TABLE_READ+" ("+ DB_COL_READ+ " text not null");
static final String SQL_CREATE_WRITE_TABLE = ("CREATE TABLE "+ DB_TABLE_WRITE+" ("+ DB_COL_WRITE+ " text not null");


public DatabaseHelper(Context context) {
    super(context, DB_NAME, null, DB_VERSION); // Context, databaseName, CursorFactory, Version
}
...
// select * from (select * from Results order by sortfield ASC limit 10) order by sortfield DESC;
